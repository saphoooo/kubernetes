...
- Le modèle des machines virtuelles s'est largement imposé vers le milieu ds années 2000 sous l'influence de 2 acteurs majeurs : VMware et Microsoft (même si ça ne venait pas de ce dernier directement).
- Sous Unix, il y a eu des initiatives aussi bien vers la machine virtuelle que vers la conteneurisation.
